...
export default function GameCard(props: GameCardProps) {
  ...
  return <a href={`${openseaTestnetBaseUrl}/assets/${ChainDetails[chain].opensea}/${ChainDetails[chain].contractAddress}/${tokenId}`} target="_blank">
    <div className="box box1 mx-4">
